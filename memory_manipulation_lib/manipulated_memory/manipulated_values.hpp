#pragma once
#define MANIPULATED_DATA_FORCE_INLINE __forceinline
...
{
private:
	array_data_t* array_address{nullptr};
...
// regular data class 
template<typename data_t>
MANIPULATED_DATA_FORCE_INLINE void manipulated_data<data_t>::restore_data()
{
	(*this->data_address) = this->overwritten_data;
}

template<typename data_t>
MANIPULATED_DATA_FORCE_INLINE void manipulated_data<data_t>::set_data(data_t _new_data)
{
...
template<typename data_t>
MANIPULATED_DATA_FORCE_INLINE data_t manipulated_data<data_t>::read_data() const
{
	return *this->data_address;
}

template<typename data_t>
MANIPULATED_DATA_FORCE_INLINE data_t* manipulated_data<data_t>::ret_data_address() const
{
	return this->data_address;
}
...
// array data class
template<typename array_data_t, std::size_t array_sz>
MANIPULATED_DATA_FORCE_INLINE array_data_t* manipulated_array_data<array_data_t, array_sz>::ret_array_address() const {
	return this->array_address;
}

template<typename array_data_t, std::size_t array_sz>
MANIPULATED_DATA_FORCE_INLINE void manipulated_array_data<array_data_t, array_sz>::set_overwritten_array(std::span<array_data_t> array)
{
	this->overwritten_array = array;
}

template<typename array_data_t, std::size_t array_sz>
MANIPULATED_DATA_FORCE_INLINE void manipulated_array_data<array_data_t, array_sz>::set_new_array(std::span<array_data_t> array)
{
	this->new_array = array;
}

template<typename array_data_t, std::size_t array_sz>
MANIPULATED_DATA_FORCE_INLINE void manipulated_array_data<array_data_t, array_sz>::set_array_index(const std::uint32_t index, array_data_t val)  const
{
	this->array_address[index] = val;
}

template<typename array_data_t, std::size_t array_sz>
MANIPULATED_DATA_FORCE_INLINE array_data_t manipulated_array_data<array_data_t, array_sz>::read_array_index(const std::uint32_t index) const
{
